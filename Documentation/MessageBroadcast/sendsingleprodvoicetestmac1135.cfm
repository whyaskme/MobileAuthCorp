...
<body>
    ...
    <!--- The method="XXX" used in the http request must match the method used to generate key in the generateSignature() function--->
 	<cfhttp url="http://ebm.messagebroadcast.com/webservice/ebm/pdc/addtorealtime" method="POST" result="returnStruct" >
       ...
       <cfhttpparam type="formfield" name="inpBatchId" value="1135" />
       ...
       <cfhttpparam type="formfield" name="inpCustomTTS" value="Hello, This is mobile auth corp. Your authorization code for the last transaction is 1 3 4 5 3 3 4 4. Again your authorization code is 1 3 4 5 3 3 4 4. To repeat this message press one." />
