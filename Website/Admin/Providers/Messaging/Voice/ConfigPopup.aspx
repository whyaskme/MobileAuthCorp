<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfigPopup.aspx.cs" Inherits="Admin.Providers.Messaging.Voice.ConfigPopup" ValidateRequest="false" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Voice Provider Config</title>
    ...
    <script type="text/javascript">
        function callParentDocumentFunction() {
            ...
            providerToAddToHiddenRetryList = providerToAddToHiddenRetryList.replace("Voice", "(Voice)");
    ...
    <form id="form1" runat="server">
        ...
        <div class="row">
            ...
            <div class="small-12 columns">
                <asp:TextBox ID="txtFromPhoneNumber" runat="server"></asp:TextBox>
            </div>
        </div>
