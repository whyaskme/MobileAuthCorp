<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GL.aspx.cs" Inherits="GL1" %>
...
<head runat="server">
    ...
    <title>Golf Advertisement Landing Page</title>
    <style>
        html {
            background: url('Images/bg_golf70.jpg') no-repeat top center fixed !important;
...
<body>
    ...
    <div class="row">
        ...
        <div class="large-8 medium-8 small-12 columns" style="text-align:center;color:#fff;margin-top:35px;padding:25px 0;border-bottom:1px solid #fff;border-top:1px solid #fff;">
            <div id="divTeeTimes" runat="server" class="keywordTitle">Reserve Tee Times Online!<span id="spanClientTeeTimes" runat="server"></span></div>
            <%--<div id="divSpecials" runat="server" class="keywordTitle">Current Online Specials!<span id="spanClientSpecials" runat="server"></span></div>--%>
            <div id="divSpecials" runat="server">
                <div class="row hide-for-small">
                    <div class="large-6 medium-6 small-12 columns" style="border-right:1px dashed #fff;">
                        <a href="#"><img src="GolfShop/img/specials/special1.png" title="Specials!" /></a>
                    </div>
                    <div class="large-6 medium-6 small-12 columns">
                        <a href="#"><img src="GolfShop/img/specials/special2.png" title="Specials!" /></a>
                    </div>
                </div>
                <div class="row show-for-small">
                    <div class="large-6 medium-6 small-12 columns" style="border-bottom:1px dashed #fff;">
                        <a href="#"><img src="GolfShop/img/specials/special1.png" title="Specials!" /></a>
                    </div>
                    <div class="large-6 medium-6 small-12 columns">
                        <a href="#"><img src="GolfShop/img/specials/special2.png" title="Specials!" /></a>
    ...
    <div class="row">
        <div class="large-12 columns">
            ...
            <p style="text-align:center;">
                <a href="#" class="button tiny radius" style="background:#2d8c36 !important;">Read More</a>
            </p>
            <p>&nbsp;</p>
        </div>
    </div>
