...
public partial class GL1 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (String.IsNullOrEmpty(adClient) == false)
            {
                ...
                {
                    if (adTypeSecondChar == "t")
                        divTeeTimes.Visible = true;
                ...
                switch (adClient)
                {
                    case "MAC Test":
                        ...
                        //spanClientTeeTimes.InnerHtml = "MAC";
                        //spanClientSpecials.InnerHtml = "MAC";
                        spanClientGeneric.InnerHtml = "MAC";
                        break;
                    case "Avenue B":
                        divLogoAvenueB.Visible = true;
                        profileAvenueB.Visible = true;
                        //spanClientTeeTimes.InnerHtml = "Avenue B";
                        //spanClientSpecials.InnerHtml = "Avenue B";
                        spanClientGeneric.InnerHtml = "Avenue B";
                        break;
                    case "STS":
                        divLogoSts.Visible = true;
                        profileSts.Visible = true;
                        //spanClientTeeTimes.InnerHtml = "STS";
                        //spanClientSpecials.InnerHtml = "STS";
                        spanClientGeneric.InnerHtml = "STS";
                        break;
                    case "TNS":
                        divLogotns.Visible = true;
                        profileTns.Visible = true;
                        //spanClientTeeTimes.InnerHtml = "TNS";
                        //spanClientSpecials.InnerHtml = "TNS";
                        spanClientGeneric.InnerHtml = "TNS";
                        break;
                    case "Scottsdale Golf Shop":
                        divLogoGolfShop.Visible = true;
                        profileGolfShop.Visible = true;
                        //spanClientTeeTimes.InnerHtml = "Scottsdale Golf Shop";
                        //spanClientSpecials.InnerHtml = "Scottsdale Golf Shop";
                    ...
                    case "Scottsdale Golf Store":
                        ...
                        //spanClientTeeTimes.InnerHtml = "Scottsdale Golf Store";
                        //spanClientSpecials.InnerHtml = "Scottsdale Golf Store";
