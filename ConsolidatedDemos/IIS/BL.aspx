<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BL.aspx.cs" Inherits="BL1" %>
...
<head runat="server">
    ...
    <title>Bank Advertisement Landing Page</title>
    <style>
        html {
...
<body>
    ...
    <div class="row">
        ...
        <div class="large-8 medium-8 small-12 columns" style="text-align:center;color:#fff;margin-top:35px;padding:25px 0;border-bottom:1px solid #fff;border-top:1px solid #fff;">
            <div id="divLoans" runat="server" class="keywordTitle">Apply Online for an Auto Loan!<span id="spanClientLoans" runat="server"></span></div>
            <div id="divCreditCards" runat="server" class="keywordTitle">0% APR Credit Card Deals!<span id="spanClientCreditCards" runat="server"></span></div>
