...
<div id="columnMain" style="background: url('images/bg-main-435.jpg') no-repeat top center;min-height:435px;">
                            ...
                            <div style="margin:0 auto;padding:0;z-index: 10;display: block;max-width:335px;width: 100%;max-height: 195px;height: auto;background: #fff !important;text-align: left;">
                                <div id="divLoginContainer">
                                    <div style="padding: 1rem 1rem 0;">
                                        <label>
                                            <?= $otpLabel ?>
                                            <input name="otpCode" type="text" id="otpCode" size="30" maxlength="50" value="" class="form-control" placeholder="Enter Authentication Code"  autocomplete="on" style="margin-top: 5px;border-radius:0 !important;"/>
                                        </label>
                                    </div>
