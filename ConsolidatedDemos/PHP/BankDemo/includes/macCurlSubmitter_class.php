  ...
  */
  ...
  class MAC_Auth {
    ...
    public function __construct($connectDelay=null, $attempts=null, $processDelay=null) {
        ...
        if(isset($_SESSION['mac-bank']['config']['requestOtpUrl']) && $_SESSION['mac-bank']['config']['requestOtpUrl'] != null) 
           $this->requestUrl  = $_SESSION['mac-bank']['config']['requestOtpUrl'];
        if(isset($_SESSION['mac-bank']['config']['verifyOtpUrl']) && $_SESSION['mac-bank']['config']['verifyOtpUrl'] != null) 
           $this->verifyUrl = $_SESSION['mac-bank']['config']['verifyOtpUrl'];
        if(isset($_SESSION['mac-bank']['config']['macbankUrl']) && $_SESSION['mac-bank']['config']['macbankUrl'] != null) 
           $this->testBankUrl = $_SESSION['mac-bank']['config']['macbankUrl'];
